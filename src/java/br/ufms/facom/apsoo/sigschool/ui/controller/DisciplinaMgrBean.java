...
@ManagedBean
@SessionScoped
public class DisciplinaMgrBean extends FormatarPDF implements Serializable
{
    ...
    public String salvarDisciplina()
    {
        if (disciplina.getId() == null)
        {
            ...
            d = disciplinaDao.buscarDisciplinaPeloNome(disciplina.getNome());
            if(d != null)
            {
                FacesUtil.mensErro("Disciplina já Cadastrada!");
                return "disciplinaform";
            }
